...
cd "raw"
ls
import delimited hotelbookingdata.csv, varnames(1) bindquotes(strict) encoding("utf-8") clear //This takes a lot of time
...
// Let's compare the average prices of the hotels in each city during december and april
